...
//   style="letters"  pure 3D letters joined by two parallel bottom rails (default)
...
// ---- letters style ----
// Pure 3D letters at natural spacing, joined by two parallel rails along the baseline.
