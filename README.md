...
| `pipeline/keyforge.ini` | Slicer profile for the Ender 3 V3 KE. |
...
`--tag` uses the solid-tag style. Output lands in `pipeline/out/`.
...
- Remaining: longevity testing across the farm.
